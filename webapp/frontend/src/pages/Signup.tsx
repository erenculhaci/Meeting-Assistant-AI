        ...
        <div className="relative">
          ...
          <div className="relative bg-[#0d1425]/80 backdrop-blur-2xl rounded-3xl border border-blue-500/10 shadow-2xl shadow-blue-900/20 p-8 overflow-hidden">
            ...
            <div className="my-6 flex items-center gap-4">
              ...
              <span className="text-blue-300/40 text-sm font-medium">or</span>
              <div className="flex-1 h-px bg-gradient-to-r from-transparent via-blue-500/30 to-transparent" />
            </div>
            ...
            <button
              ...
              className="w-full py-3.5 px-4 bg-white hover:bg-gray-50 border border-gray-300 rounded-xl flex items-center justify-center gap-3 transition-all duration-300 group mb-6"
            >
